...
/// <summary>
/// Summary description for ContactLogRepository
/// </summary>
public class ContactLogRepository : IDisposable
{
    ...
    public void Insert(string name, string email, string subject, string message, DateTime? date = null){
        if (!date.HasValue){
         ...
         _db.Execute("INSERT INTO ContactLog(Name, Email, Subject, Message, DateSent) Values (@0, @1, @2, @3, @4)", name, email, subject, message, date);
    }
